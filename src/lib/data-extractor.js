...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { program: peg$parseprogram, desc: peg$parsedesc, more: peg$parsemore, expr: peg$parseexpr, identifier: peg$parseidentifier, string: peg$parsestring, _: peg$parse_, SEP: peg$parseSEP, INDENT: peg$parseINDENT, EXTEND: peg$parseEXTEND, UNDENT: peg$parseUNDENT, INDENTATION: peg$parseINDENTATION };
  ...
  var peg$c8 = "lParen";
  var peg$c9 = "?";
  var peg$c10 = "optional";
  var peg$c11 = ".";
  var peg$c12 = "lSelectors";
  var peg$c13 = "=";
  var peg$c14 = "expected";
  var peg$c15 = "as";
  var peg$c16 = ")";
  var peg$c17 = "rParen";
  var peg$c18 = "str";
  ...
  var peg$f3 = function(result) {
			let [name, obj] = result;
			lStack.push(obj)
			return true;
			};
  var peg$f4 = function(result, h) {
			lStack.pop();
			let [name, obj] = result;
			return 'OK'
			};
  var peg$f5 = function(h) {
			return h;
			};
  var peg$f6 = function(lParen, optional, lSelectors, expected, as, rParen) {
  ...
  var peg$f8 = function(lChars) {
		return lChars.join('');
		};
  var peg$f9 = function(hInfo) {return isSep(hInfo)};
  var peg$f10 = function(hInfo) { return parse__SEP__1(hInfo); };
  var peg$f11 = function(hInfo) {return isIndent(hInfo)};
  var peg$f12 = function(hInfo) { return parse__INDENT__1(hInfo); };
  var peg$f13 = function(hInfo) {return isExtend(hInfo)};
  var peg$f14 = function(hInfo) { return parse__EXTEND__1(hInfo); };
  var peg$f15 = function(hInfo) {return isUndent(hInfo)};
  var peg$f16 = function(hInfo) { return parse__UNDENT__1(hInfo); };
  var peg$f17 = function(lTabs) { return parse__INDENTATION__1(lTabs); };
