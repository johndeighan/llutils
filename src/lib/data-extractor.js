...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { data: peg$parsedata, desc: peg$parsedesc, expr: peg$parseexpr, listexpr: peg$parselistexpr, ident: peg$parseident, string: peg$parsestring, _: peg$parse_, SEP: peg$parseSEP, INDENT: peg$parseINDENT, EXTEND: peg$parseEXTEND, UNDENT: peg$parseUNDENT, INDENTATION: peg$parseINDENTATION };
  var peg$startRuleFunction = peg$parsedata;
