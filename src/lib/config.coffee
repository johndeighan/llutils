...
import {isFile, slurp} from '@jdeighan/llutils/fs'
...
import {procNearleyFile} from '@jdeighan/llutils/nearley'
...
export hConfig = {
	...
	'.coffee': { strFunc:   procCoffee,   outExt: '.js' }
	'.cielo':  { strFunc:   procCielo,    outExt: '.js' }
	'.peggy':  { strFunc:   procPeggy,    outExt: '.js' }
	'.ne   ':  { fileFunc:  procNearleyFile,  outExt: '.js' }
	'.svelte': { strFunc:   procSvelte,   outExt: '.js' }
	'.dot':    { strFunc:   procDot,      outExt: '.png'}
	}
