...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { token: peg$parsetoken, boolean: peg$parseboolean, number: peg$parsenumber, string: peg$parsestring, identifier: peg$parseidentifier, NL: peg$parseNL, _: peg$parse_ };
  var peg$startRuleFunction = peg$parsetoken;
