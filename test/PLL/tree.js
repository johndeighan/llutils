...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { tree: peg$parsetree, stmt: peg$parsestmt, identifier: peg$parseidentifier, one_ident: peg$parseone_ident, NL: peg$parseNL, SEP: peg$parseSEP, INDENT: peg$parseINDENT, EXTEND: peg$parseEXTEND, UNDENT: peg$parseUNDENT, INDENTATION: peg$parseINDENTATION };
  ...
  function peg$parseidentifier() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseone_ident();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parseEXTEND();
      if (s4 !== peg$FAILED) {
        s5 = peg$parseone_ident();
        if (s5 !== peg$FAILED) {
          s3 = s5;
        } else {
          peg$currPos = s3;
