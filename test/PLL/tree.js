...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { tree: peg$parse_tree, stmt: peg$parse_stmt, identifier: peg$parse_identifier, one_ident: peg$parse_one_ident, NL: peg$parse_NL, SEP: peg$parse_SEP, INDENT: peg$parse_INDENT, EXTEND: peg$parse_EXTEND, UNDENT: peg$parse_UNDENT, INDENTATION: peg$parse_INDENTATION };
  var peg$startRuleFunction = peg$parse_tree;
  ...
  var peg$f0 = function(lStmts) { return parse__tree__1(lStmts); };
  var peg$f1 = function(ident, children) { return parse__stmt__1(ident, children); };
  var peg$f2 = function(first, lMore) { return parse__identifier__1(first, lMore); };
  var peg$f3 = function(str) {return (str != 'if');};
  var peg$f4 = function(str) { return parse__one_ident__1(str); };
  ...
  function peg$parse_identifier() {
    ...
    s0 = peg$currPos;
    s1 = peg$parse_one_ident();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse_EXTEND();
      if (s4 !== peg$FAILED) {
        s5 = peg$parse_one_ident();
        if (s5 !== peg$FAILED) {
          s3 = s5;
        } else {
          peg$currPos = s3;
