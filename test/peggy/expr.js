...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { expr: peg$parse_expr, term: peg$parse_term, factor: peg$parse_factor, addOp: peg$parse_addOp, mulOp: peg$parse_mulOp, ws: peg$parse_ws, integer: peg$parse_integer, float: peg$parse_float, number: peg$parse_number };
  var peg$startRuleFunction = peg$parse_expr;
  ...
  var peg$f0 = function(left, op, right) { return parse__expr__1(left, op, right); };
  var peg$f1 = function(left, op, right) { return parse__term__1(left, op, right); };
  var peg$f2 = function(f) { return parse__factor__2(f); };
  var peg$f3 = function(str) { return parse__integer__1(str); };
  var peg$f4 = function(digits, decimal) { return parse__float__1(digits, decimal); };
