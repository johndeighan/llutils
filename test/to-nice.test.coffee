...
equal toNICE(['a','b',undef,true]), """
	- a
	- b
	- .undef.
	- .true.
	"""
equal toNICE({a:1, b:2, c:undef, d:true}), """
	a: 1
	b: 2
	c: .undef.
	d: .true.
	"""
equal toNICE(['a',['b','c'],undef,true]), """
	- a
	-
		- b
		- c
	...
	- .true.
	"""
equal toNICE(['a',{a:'a',b:'b'},undef,true]), """
	- a
	-
		a: a
		b: b
	...
	- .true.
	"""
equal toNICE({a:1, b:['c','d'], c:undef, d:true}), """
	a: 1
	b:
		- c
		- d
	...
	d: .true.
	"""
equal toNICE({a:1, b:{c:1, d:2}, c:undef, d:true}), """
	a: 1
	b:
		c: 1
		d: 2
...
h = {c: undef, a:1, d: true, b:{c:1, d:2}}
...
equal toNICE(h, {sortKeys: ['d','c','b','a']}), """
	d: .true.
	c: .undef.
	b:
		d: 2
...
equal toNICE(h, {sortKeys: ['d','c','a','b']}), """
	d: .true.
	c: .undef.
	a: 1
	b:
